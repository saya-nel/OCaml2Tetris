...
let caml_greaterequal_code v1 v2 = Mlvalues.val_long (Prims.geint (Mlvalues.long_val v1) (Mlvalues.long_val v2))

let caml_lessequal = 3
let caml_lessequal_code v1 v2 = Mlvalues.val_long (Prims.leint (Mlvalues.long_val v1) (Mlvalues.long_val v2))

let caml_int_compare = 4
let caml_compare = 4
let caml_int_compare_code v1 v2 = Mlvalues.val_long (Prims.compare_imm (Mlvalues.long_val v1) (Mlvalues.long_val v2))
