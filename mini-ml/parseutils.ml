...
let string_of_position {start_pos={pos_lnum=l1;pos_cnum=c1};end_pos={pos_lnum=l2;pos_cnum=c2}} =
	if l1 = l2 then sprintf "line %d, characters %d-%d" l1 c1 c2
    else sprintf "form line %d, characters %d, to line %d characters %d" l1 c1 l2 c2
