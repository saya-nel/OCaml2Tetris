...
and rw_exp env Past.{exp_desc;exp_loc} =
  ...
  | Past.Ref_access(e1) -> Ast.App(Ast.Ident("Pervasives.ref_contents"),[rw_exp env e1])
  | Past.Ref_assign(e1,e2) -> Ast.App(Ast.Ident("Pervasives.ref_set_contents"),[rw_exp env e1;rw_exp env e2])
  | Past.Ref(e) -> Ast.App(Ast.Ident("Pervasives.ref"),[rw_exp env e])
  | Past.Array_access(e1,e2) -> Ast.App(Ast.Ident("Array.get"),[rw_exp env e1;rw_exp env e2])
  | Past.Array_assign(e1,e2,e3)  -> Ast.App(Ast.Ident("Array.set"),[rw_exp env e1;rw_exp env e2;rw_exp env e3])
